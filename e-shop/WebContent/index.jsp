				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotProductList }" var="hotpro">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href='${pageContext.request.contextPath }/product?method=product_info&pid=${hotpro.pid}'>
								<img src="${pageContext.request.contextPath }/${hotpro.pimage}" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath}/product?method=product_info&pid=${hotpro.pid}" style='color:#666'>${fn:substring(hotpro.pname,0,10) }</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newProductList }" var="newpro">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath}/product?method=product_info&pid=${newpro.pid}">
								<img src="${pageContext.request.contextPath }/${newpro.pimage}" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath}/product?method=product_info&pid=${newpro.pid}" style='color:#666'>${fn:substring(newpro.pname,0,10) }</a></p>
