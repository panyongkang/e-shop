	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ac.equals("login"))
		{
			...
			if(!pagerandom.equals(random)&&request.getParameter("a")!=null)
			{
				...
				String sql1="";
				if (utype.equals("注册用户")){sql1 = "select * from zhuceyonghu where yonghuming='"+username+"' and mima='"+password+"' and issh='是'"; }
		...
		List<HashMap> userlist1 = dao.select(sql1);
			...
			if(userlist1.size()==1)
			{
				...
				request.getSession(). setAttribute("yue", userlist1.get(0).get("yue"));  
