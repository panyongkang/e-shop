...
<div class="content">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>图书编号：</td><td width='39%'><%=mqt.get("tushubianhao")%></td><td  rowspan=5 align=center><a href=<%=mqt.get("tupian")%> target=_blank><img src=<%=mqt.get("tupian")%> width=228 height=215 border=0></a></td></tr><tr>         <td width='11%' height=44>图书名称：</td><td width='39%'><%=mqt.get("tushumingcheng")%></td></tr><tr>         <td width='11%' height=44>图书类别：</td><td width='39%'><%=mqt.get("tushuleibie")%></td></tr><tr>         <td width='11%' height=44>出售价格：</td><td width='39%'><%=mqt.get("chushoujiage")%></td></tr><tr>                           <td width='11%' height=44>销量：</td><td width='39%'><%=mqt.get("xiaoliang")%></td></tr><tr>         <td width='11%' height=100  >详细介绍：</td><td width='39%' colspan=2 height=100 ><%=mqt.get("xiangxijieshao")%></td></tr><tr>							 
							...
							int i=0;
							 ...
							 %>
                                ...
                                </tr><tr><td colspan=3 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 onClick="javascript:window.print()" /> <input type="button" name="tushuxinxigoumai" value="购买" onclick="javascript:location.href='goumaijiluadd.jsp?id=<%=id%>';"> <!--jixaaxnnxiu--><input type=button name=Submit53 value=评论 onClick="javascript:hsgpinglun('tushuxinxi','<%=id%>')"/></td></tr>
