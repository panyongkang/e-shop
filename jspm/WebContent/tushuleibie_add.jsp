...
new CommDAO().insert(request,response,"tushuleibie",ext,true,false,""); 
...
%>
  ...
  <body >
 <form  action="tushuleibie_add.jsp?f=f&id=<%=id%>"  method="post" name="form1"  onsubmit="return checkform();">
  添加图书类别:
  <br><br>
...
if(leibieobj.value!=""){  
var ajax = new AJAX();
ajax.post("factory/checkno.jsp?table=tushuleibie&col=leibie&value="+leibieobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>") 
