 ...
 %>
  ...
  <form name="form2" method="post" action="delall.jsp">
	...
	%>
        ...
        <td width="60" align="center"><a href="xinwentongzhi_updt.jsp?id=<%=map.get("id")%>">修改</a> <a onClick="return confirm('确定要删除这条记录吗?')"  href="xinwentongzhi_list.jsp?&lb=<%=lb%>&scid=<%=map.get("id")%>">删除</a></td>
