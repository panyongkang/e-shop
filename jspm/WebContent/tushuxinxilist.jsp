...
<div class="content">
   ...
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit5" value="切换视图"  style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='tushuxinxilisttp.jsp';" />
</form>
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">  
  ...
  <% 
    ...
    String url = "tushuxinxilist.jsp?issh=是"; 
...
if (request.getParameter("chushoujiage2")==""  ||request.getParameter("chushoujiage2")==null ) {}else {sql=sql+" and chushoujiage <= '"+request.getParameter("chushoujiage2")+"'";}
  ...
  <tr>
    ...
    <td width="30" align="center"> <a href="tushuxinxidetail.jsp?id=<%=map.get("id")%>" >详细</a></td>
  </tr>
  	<%
  }
   %>
