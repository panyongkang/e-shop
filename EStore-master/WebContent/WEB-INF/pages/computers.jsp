			...
			<div class="container searchBox">
		 	...
		 	<div class="container">
					...
					<c:forEach items="${computerpage.list }" var="computer">
						  ...
						  <div class="col-sm-6 col-md-4">
							  <a href="computerServlet?method=getComputer&pageNo=${computerpage.pageNo }&id=${computer.id}" >
								      ...
								      <div class="caption">
								        <h3 style="color:bule;black;overflow: hidden;text-overflow:ellipsis;white-space: nowrap;">${computer.brand }&nbsp;${computer.model }</h3>
					...
					<c:if test="${computerpage.hasPrev }">
						<a class="btn btn-primary" role = "button" href="computerServlet?method=getComputers&pageNo=1">首页</a>
						&nbsp;&nbsp;
						<a class="btn btn-info" role = "button" href="computerServlet?method=getComputers&pageNo=${computerpage.prevPage }">上一页</a>
					</c:if>
			
					&nbsp;&nbsp;
					
					<c:if test="${computerpage.hasNext }">
						<a class="btn btn-success" role = "button" href="computerServlet?method=getComputers&pageNo=${computerpage.nextPage }">下一页</a>
						&nbsp;&nbsp;
						<a class="btn btn-warning" role = "button" href="computerServlet?method=getComputers&pageNo=${computerpage.totalPageNumber }">末页</a>
					</c:if>
