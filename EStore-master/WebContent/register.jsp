	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="registerForm"  class="form-horizontal" style="margin-top: 5px;" method="post" action="${pageContext.request.contextPath }/userServlet?method=register"  autocomplete="off">
					...
					<div class="form-group float-left">
						<div class="col-sm-offset-2 col-sm-10">
							<input type="reset" width="100" value="重置" name="reset"
