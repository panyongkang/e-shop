...
<nav class="navbar navbar-default navbar-static-top">
	      <div class="container">
		        <div class="navbar-header">
		          ...
		          <a class="navbar-brand" href="computerServlet?method=getComputers"><span class="glyphicon glyphicon-blackboard"></span> 百脑科技商城</a>
		        </div>
		          ...
		          <ul class="nav navbar-nav navbar-right">
      				...
      				<span class="badge">${sessionScope.ShoppingCart.computerNumber }</span>
	       	 		...
	       	 		<li class="dropdown">
		          		...
		          		<span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;用户名:${sessionScope.user.username}
