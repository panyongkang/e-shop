...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
			<h3>2020年神秘员工管理</h3>
			<!--##注意##：加一个[0]才能获取值，因为el表达式获取user是list集合，通过下标才能获取对应的值  -->
			<h3>欢迎管理员<c:out value="${sessionScope.user[0].username}" />！</h3>
			<a class=" btn btn-warning" href="${APP_PATH}/user/doLogout">
						退出登录
					</a>
			</div>
		</div>
